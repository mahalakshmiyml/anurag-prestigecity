...
import Image2 from "../../../images/projects/aspen-greens/4bhk/type-a-radial-ground-floor.png";
...
const AspenFourBhk = () => {
  const ThreeBHKImages = [
    ...
    { id: 5, imgName: Image5, alt: "", tag: "Type-B Rectangle Ground-floor" },
    { id: 6, imgName: Image6, alt: "", tag: "Type-B Rectangle Ground-floor" },
    { id: 7, imgName: Image7, alt: "", tag: "Type-B Rectangle Ground-floor" },
  ];
